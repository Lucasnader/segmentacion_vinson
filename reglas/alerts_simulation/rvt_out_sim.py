...
def simulate_rvt_out(
    ...
    *,
    ...
    """
    RVT-OUT:
      OUT & Cash, montos redondos; ventana 30d con (count > Number) y (sum > Amount).
      Unidad = ventanas (cliente, día). Se cuentan >= count_from.
    """
