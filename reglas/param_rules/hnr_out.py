...
def run_parameters_hnr_out(path: str, subsubsegments: Union[str, Iterable[str]], *, verbose: bool=False) -> Dict[str, Any]:
    ...
    if miss:
        raise KeyError(f"Faltan columnas para HNR-OUT: {miss}")
